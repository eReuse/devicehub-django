...
class RootAliasDepth1Tests(TestCase):
    ...
    def test_has_dependents_false_for_lone_self_ref(self):
        ...
        self.assertFalse(RootAlias.has_dependents(self.institution, "ereuse24:a1"))
    ...
    def test_has_dependents_true_when_other_alias_points_to_it(self):
        ...
        self.assertTrue(RootAlias.has_dependents(self.institution, "ereuse24:a2"))
    ...
    def test_set_alias_rejects_non_terminal_target(self):
        ...
        RootAlias.set_alias(self.institution, "ereuse24:a2", "ereuse24:a3")
    ...
    def test_set_alias_allows_self_ref_even_with_dependents(self):
        ...
        RootAlias.set_alias(self.institution, "ereuse24:a2", "ereuse24:a2")
        ra = RootAlias.objects.get(owner=self.institution, alias="ereuse24:a2")
        self.assertEqual(ra.root, "ereuse24:a2")
...
class RootAliasSyncMembershipsTests(TestCase):
    ...
    def setUp(self):
        ...
        for v in ["ereuse24:x1", "ereuse24:x2"]:
    ...
    def test_set_alias_reset_to_self_ref_is_allowed(self):
        ...
        self.assertEqual(ra.root, "ereuse24:x1")
    ...
    def test_reset_migrates_orphan_lot_row_back_to_alias(self):
        ...
        self.lot.add("ereuse24:x1")
        RootAlias.set_alias(self.institution, "ereuse24:x1", "custom_id:solo")
        self.assertEqual(
            DeviceLot.objects.get(lot=self.lot).device_id,
            "custom_id:solo",
        )
        RootAlias.set_alias(self.institution, "ereuse24:x1", "ereuse24:x1")
        self.assertEqual(
            DeviceLot.objects.get(lot=self.lot).device_id, "ereuse24:x1"
        )
    ...
    def test_set_alias_collapses_existing_devicebeneficiary_rows(self):
        ...
        DeviceBeneficiary.objects.create(
            beneficiary=b, device_id="ereuse24:x1",
            status=DeviceBeneficiary.Status.INTERESTED,
        )
        DeviceBeneficiary.objects.create(
            beneficiary=b, device_id="ereuse24:x2",
            status=DeviceBeneficiary.Status.INTERESTED,
        )
