...
Install playwright with `npm install playwright@latest`, then, run all the tests with `./run.sh`, by default, it assumes that a docker deployment (`./docker-reset.sh`) is running in http://127.0.0.1:8001
