...
# generated by Django (including the token QR payload) keep https:// instead
# of sending clients through an HTTP-to-HTTPS redirect.
SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https')


INITIAL_ADMIN_EMAIL = config("DEVICEHUB_INIT_ADMIN_EMAIL", default='admin@example.org')
INITIAL_ADMIN_PASSWORD = config("DEVICEHUB_INIT_ADMIN_PASSWORD_SECRET", default='1234')
