...
class NewDeviceView(DashboardView, FormView):
    ...
    title = _("New Device")
    breadcrumb = [(_("Device"), None), (_("New Device"), None)]
...
class EditDeviceView(DashboardView, UpdateView):
    ...
    breadcrumb = [(_("Device"), None), (_("Update Device"), None)]
...
class DetailsView(DashboardView, TemplateView ):
    ...
    title = _("Device")
    breadcrumb = [(_("Device"), None), (_("Details"), None)]
...
class AddUserPropertyView(DeviceLogMixin, CreateView):
    ...
    breadcrumb = [(_("Device"), None), (_("New Property"), None)]
    model = UserProperty
    fields = ("key", "value")
...
class UpdateUserPropertyView(DeviceLogMixin, UpdateView):
    ...
    breadcrumb = [(_("Device"), None), (_("Update Property"), None)]
    model = UserProperty
    fields = ("key", "value")
