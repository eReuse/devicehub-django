...
def queryset_SQL(institution, offset=0, limit=None):
...
def queryset_SQL_count(institution):
    institution_id = institution.id
...
def queryset_SQL_unassigned(institution, offset=0, limit=None):
    institution_id = institution.id
...
def queryset_SQL_unassigned_count(institution):
    institution_id = institution.id
