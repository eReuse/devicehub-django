...
docker_wizard__custom() {
        ...
        use_env_var DEVICEHUB_INIT_ADMIN_PASSWORD_REQUEST '1234'
...
docker_wizard__dev() {
        ...
        export DEVICEHUB_INIT_ADMIN_PASSWORD_REQUEST='1234'
